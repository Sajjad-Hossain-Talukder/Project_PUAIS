        ...
        <div class="col-lg-8"  >
            <div class="row">
                ...
                <div class="col-lg-12 text-center my-4">
                    <div class="row">
                        <div class="col-lg-6">
                            <a href="teacher_resister.php" class="btn btn-outline-dark" style="width:16rem;"><h4>Resister</h4></a>      
                        </div>
                        <div class="col-lg-6">
                        <a href="teacher_login.php" class="btn btn-outline-dark" style="width:16rem;"><h4>Login</h4></a>     
                        </div>
