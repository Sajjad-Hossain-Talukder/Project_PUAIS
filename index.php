        ...
        <div class="col-lg-8"  >
            <div class="row">
                ...
                <div class="col-lg-12 text-center my-4">
                    <div class="row">
                        <div class="col-lg-4">
                            <a href="teacher_login.php" class="btn btn-outline-dark" style="width:11rem;"><h4>Teacher</h4></a>      
                        </div>
                        <div class="col-lg-4">
                        <a href="admin_login.php" class="btn btn-outline-dark" style="width:14rem;"><h4>Admin</h4></a>     
                        </div>
                        <div class="col-lg-4">
                            <a href="student_login.php" class="btn btn-outline-dark" style="width:11rem;"><h4>Student</h4></a>     
                        </div>
                    </div>
                </div>
            </div>
