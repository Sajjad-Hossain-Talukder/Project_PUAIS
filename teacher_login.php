            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title text-center"><h2>Teacher Login</h2></div>
                    </div> 
                    <div class="card-body">
                        ...
                        <div  style="margin-left:15%; font-size:20px;">
                            ...
                            <p style="margin-left:10%">Password or Teacher Id is Wrong</p>
                    ...
                    <div class="card-footer text-center">
                        <h6>Need an Account ? <a href="teacher_resister.php" style="text-decoration : none;">Resister</a> </h6>
                    </div>
                </div>
            </div>
        </div>
...
if( isset($_POST['sub'])){
    ...
    if ( empty($_POST['tid']) || empty($_POST['pass']) ){
       header("location:teacher_login.php?Empty=teacherID and pass");
    }
    else {

        $sql = "select * from teacher where T_Id = '".$_POST['tid']."' and pass = '".$_POST['pass']."'";
        ...
        if (mysqli_fetch_assoc($q)){
            ...
            header("location:teacher_login.php?invalid=id and password is invalid");
        }
    }
